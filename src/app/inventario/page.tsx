...
import { MobileStockList } from "@/components/mobile-stock-list";
...
export default async function InventarioPage() {
  ...
  return (
    <div className="flex flex-col gap-6 w-full min-h-[calc(100vh-6rem)]">
      ...
      {/* VISTA ESCRITORIO: Se oculta en pantallas de teléfonos (menores a md) */}
      <div className="hidden md:block">
        <StockTable
          ...
          depositos={depositos}
          usuarioId={(session as any)?.id as number}
        />
      </div>

      {/* VISTA MÓVIL PWA: Se muestra sólo en teléfonos (se oculta desde md en adelante) */}
      <div className="block md:hidden -mx-4 sm:mx-0">
        <MobileStockList
          data={data}
          listasGlobales={listasGlobales}
        />
