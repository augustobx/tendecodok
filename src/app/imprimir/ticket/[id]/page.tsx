    ...
    return (
        <div className="w-[80mm] min-h-[100px] bg-white dark:bg-zinc-900 text-black font-mono text-[12px] leading-tight mx-auto print:mx-auto pb-10">
                ...
                <table className="w-full text-left">
                    ...
                    <tbody>
                        {Object.values(venta.detalles.reduce((acc: any, det: any) => {
                            const nombre = det.producto.nombre_producto;
                            if (!acc[nombre]) {
                                acc[nombre] = {
                                    id: det.id,
                            ...
                            // Asumimos que si tienen descuentos diferentes se agruparon en el carrito con 0, pero si tienen, mostramos el del primero.
                            return acc;
                        }, {})).map((det: any) => (
            ...
            <div className="border-b-2 border-black border-dashed pb-3 mb-4 space-y-1">
                ...
                {venta.notas_venta && (
                    <div className="text-[10px] mt-2 pt-2 border-t border-black border-dashed whitespace-pre-wrap text-left">
                        <span className="font-bold uppercase">Notas:</span><br/>
                        {venta.notas_venta}
                    </div>
                )}
            </div>
